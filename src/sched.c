...
/**
 * @file sched.c
 * This file contains the game's scheduler and task-dispatch logic.
 */
...
/**
 * 1900	70000D00
 * Scheduler message-loop entry point. The argument remains void* because it is
 * passed through the thread callback ABI before being cast back to OSSched.
 */
void __scMain(void *arg)
{
    OSMesg msg = NULL;
