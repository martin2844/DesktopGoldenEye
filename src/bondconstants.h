...
*/} NAME;
#else
/* Non-SGI: BITFLAG macro is no-op, manual enum fallbacks provided below */
#    define BITFLAG(...)

/* Manual expansions of BITFLAG for non-SGI compilers (clang/gcc).
 * ATTACKTYPE already has a manual definition below in the Bitflags region. */

typedef enum FLAGS2 {
    FLAGS2_NONE = 0,
    FLAGS2_DONT_POINT_AT_BOND = 1 << 0, FLAGS2_02 = 1 << 1, FLAGS2_04 = 1 << 2
} FLAGS2;
...
typedef enum DOOR_LOCK {
    DOOR_LOCK_NONE = 0,
    DOOR_LOCK_0 = 1 << 0, DOOR_LOCK_1 = 1 << 1, DOOR_LOCK_2 = 1 << 2, DOOR_LOCK_3 = 1 << 3,
    DOOR_LOCK_4 = 1 << 4, DOOR_LOCK_5 = 1 << 5, DOOR_LOCK_6 = 1 << 6, DOOR_LOCK_7 = 1 << 7
} DOOR_LOCK;

typedef enum PLAYERFLAG {
    PLAYERFLAG_NONE = 0,
    PLAYERFLAG_LOCKCONTROLS = 1 << 0, PLAYERFLAG_NOCONTROL = 1 << 1, PLAYERFLAG_NOTIMER = 1 << 2
} PLAYERFLAG;

typedef enum RUNTIMEBITFLAG {
    RUNTIMEBITFLAG_NONE = 0,
    RUNTIMEBITFLAG_00000001 = 1 << 0, RUNTIMEBITFLAG_00000002 = 1 << 1,
    RUNTIMEBITFLAG_REMOVE = 1 << 2, RUNTIMEBITFLAG_ISRETICK = 1 << 3,
    RUNTIMEBITFLAG_TAGGED = 1 << 4, RUNTIMEBITFLAG_THROWING_KNIFE_RELATED = 1 << 5,
    RUNTIMEBITFLAG_EMBEDDED = 1 << 6, RUNTIMEBITFLAG_DEPOSIT = 1 << 7,
    RUNTIMEBITFLAG_00000100 = 1 << 8, RUNTIMEBITFLAG_BEENOPENED = 1 << 9,
    RUNTIMEBITFLAG_DESTROYED = 1 << 10, RUNTIMEBITFLAG_00000800 = 1 << 11,
    RUNTIMEBITFLAG_00001000 = 1 << 12, RUNTIMEBITFLAG_PADLOCKEDDOOR = 1 << 13,
    RUNTIMEBITFLAG_ACTIVATED = 1 << 14, RUNTIMEBITFLAG_00008000 = 1 << 15,
    RUNTIMEBITFLAG_00010000 = 1 << 16, RUNTIMEBITFLAG_00020000 = 1 << 17,
    RUNTIMEBITFLAG_00040000 = 1 << 18, RUNTIMEBITFLAG_HASOWNER = 1 << 19,
    RUNTIMEBITFLAG_00100000 = 1 << 20, RUNTIMEBITFLAG_00200000 = 1 << 21,
    RUNTIMEBITFLAG_00400000 = 1 << 22, RUNTIMEBITFLAG_00800000 = 1 << 23,
    RUNTIMEBITFLAG_01000000 = 1 << 24, RUNTIMEBITFLAG_02000000 = 1 << 25,
    RUNTIMEBITFLAG_04000000 = 1 << 26, RUNTIMEBITFLAG_08000000 = 1 << 27,
    RUNTIMEBITFLAG_10000000 = 1 << 28, RUNTIMEBITFLAG_20000000 = 1 << 29,
    RUNTIMEBITFLAG_40000000 = 1 << 30, RUNTIMEBITFLAG_80000000 = 1u << 31
} RUNTIMEBITFLAG;

typedef enum WEAPONSTATBITFLAG {
    WEAPONSTATBITFLAG_NONE = 0,
    WEAPONSTATBITFLAG_00000001 = 1 << 0, WEAPONSTATBITFLAG_SINGLE_USE_RELOAD = 1 << 1,
    WEAPONSTATBITFLAG_BURST_FIRE = 1 << 2, WEAPONSTATBITFLAG_HAS_AUTO_AIM = 1 << 3,
    WEAPONSTATBITFLAG_CLICKY = 1 << 4, WEAPONSTATBITFLAG_00000020 = 1 << 5,
    WEAPONSTATBITFLAG_00000040 = 1 << 6, WEAPONSTATBITFLAG_00000080 = 1 << 7,
    WEAPONSTATBITFLAG_ONLY_1_HANDED = 1 << 8, WEAPONSTATBITFLAG_HOLD_AS_GUN = 1 << 9,
    WEAPONSTATBITFLAG_MIRROR_DUAL = 1 << 10, WEAPONSTATBITFLAG_SHOW_FIRST_PERSON = 1 << 11,
    WEAPONSTATBITFLAG_FIRST_SHOT_ACCURACY = 1 << 12, WEAPONSTATBITFLAG_HIDE_FIRST_PERSON_HAND = 1 << 13,
    WEAPONSTATBITFLAG_HIDE_FIRST_PERSON_MENU = 1 << 14, WEAPONSTATBITFLAG_DISABLE_CROUCH = 1 << 15,
    WEAPONSTATBITFLAG_PLAYER_STAT_HIT = 1 << 16, WEAPONSTATBITFLAG_USE_HOLD_TIME = 1 << 17,
    WEAPONSTATBITFLAG_HAS_AMMO = 1 << 18, WEAPONSTATBITFLAG_HIDE_AMMO_DISPLAY = 1 << 19,
    WEAPONSTATBITFLAG_CAN_DUAL_WIELD = 1 << 20, WEAPONSTATBITFLAG_AMMO_CLIP_LIMIT = 1 << 21,
    WEAPONSTATBITFLAG_NO_CLIP_RELOADS = 1 << 22, WEAPONSTATBITFLAG_00800000 = 1 << 23,
    WEAPONSTATBITFLAG_01000000 = 1 << 24, WEAPONSTATBITFLAG_02000000 = 1 << 25,
    WEAPONSTATBITFLAG_04000000 = 1 << 26, WEAPONSTATBITFLAG_08000000 = 1 << 27,
    WEAPONSTATBITFLAG_10000000 = 1 << 28, WEAPONSTATBITFLAG_20000000 = 1 << 29,
    WEAPONSTATBITFLAG_40000000 = 1 << 30, WEAPONSTATBITFLAG_80000000 = 1u << 31
} WEAPONSTATBITFLAG;
...
#define CharArrayTo16(val, index) (((u16)(val)[(index) + 1]) | ((u16)(val)[(index)] << 8))
#define CharArrayTo24(val, index) (((u32)(val)[(index) + 1] << 8) | ((u32)(val)[(index) + 2]) | ((u32)(val)[(index)] << 16))
#define CharArrayTo32(val, index) (((u32)(val)[(index) + 1] << 16) | ((u32)(val)[(index) + 2] << 8) | ((u32)(val)[(index) + 3]) | ((u32)(val)[(index)] << 24))
    /* Pad Catagory */
...
#else
/* Non-SGI: & cannot be token-pasted */
#define CHRFILERECORD(NAME, SCALE, OFFSET, HASHEAD, ISMALE) \
    {& NAME ## _header, STR(C##NAME##Z), SCALE, OFFSET, HASHEAD, ISMALE},
#define GUNSTATS(NAME) & NAME ## _stats
#define GUNFILERECORD(NAME, NOMODEL, STATS, UPPERTEXTID, LOWERTEXTID, POSX, POSY, POSZ, XROT, YROT, WOCTEXT, EQUIPTEXT, EQUIPX, EQUIPY, EQUIPZ) \
...
#else
/* Non-SGI: IF_ELSE/IS_EMPTY macros don't work, use SCALE directly */
#define PROPFILERECORD(NAME, SCALE)        \
