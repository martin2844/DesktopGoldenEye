...
#ifdef NATIVE_PORT
extern void osReadHost(void *buffer, u32 size);
extern void osWriteHost(void *buffer, u32 size);
#endif
...
void indyrescmdCheckFileExists(s32 rsize,s32 wsize,const char *name)
{
...
void indyrescmdSendFileLoad(u32 rsize,u32 wsize,const char *filename,u32 size)
{
...
void post_type8_indyrescmd_log_recieved(s32 rsize,s32 wsize,u32 data1,u32 data2,u32 cmd2size,indy_resource_entry_header *cmd2)
{
   ...
   send2indyresourcecommands(&cmd.entry,sizeof(indy_resource_entry_type8),cmd2,cmd2size);
}


void indyrescmdSendDump(s32 rsize,s32 wsize,const char *strptr,u32 size2,indy_resource_entry_header *cmd2)
{
  ...
  send2indyresourcecommands(&cmd.entry,sizeof(indy_resource_entry_type9),cmd2,size2);
...
void indyrescmdRamRomLoad(u32 rsize,u32 wsize,const char *name,u32 filesize,u8 *ptarget)
{
  ...
  cmd.strbuffer[255] = '\0';
  cmd.size = filesize;
  cmd.hwaddress = (u8 *)(uintptr_t)ptarget;
...
void indyrescmdSendExportFile(u32 rsize,u32 wsize,const char *ptrstr,u32 size,u8 *hwaddress)
{
...
void indyrescmdSendHostCmd(s32 rsize,s32 wsize,const char *strptr)
{
...
s32 indycmdSendHostCheckFileExists(const char *strptr)
{
...
s32 indycmdSendLoadFile(const char *filename,u32 size)
{
...
s32 indycmdSendDump(const char *string, u32 size, void *data)
{
...
s32 indycmdSendRamRomLoad(const char *strptr,u8 *ptarget,u32 filesize)
{
...
s32 post_indyrescmd_1_10_2(u32 data1, u32 data2, u32 data3)
{
    indyrescmdStartCmdSeq(sizeof(indy_resource_entry_type10),sizeof(indy_resource_entry_type10));
    post_type10_indyrescmd_fault_ack_by_host(sizeof(s_indyResCmd02End),sizeof(s_indyResCmd02End),data1,data2,data3);
    indyrescmdEndCmdSeq(0,0);
...
s32 indycmdSendHostExportFile(const char *strptr,u8 *phwaddr,u32 size)
{
...
s32 response_indyrescmd_1_4_2(u8 *response)
{
    ...
    post_indyrescmd_istype4_correctvalue(0x14,0x14,(u32 *)response);
...
s32 indycmdAckHostCheckFileExists(u8 *response1,u8 *response2)
{
    ...
    indyrescmdResponseFileExists(0x14,0x14,(u32 *)response1,(u32 *)response2);
    indyrescmdResponseEnd(0,0);
...
s32 indycmdReceiveFile(u8 *response1,u8 *response2,u32 *childsize,u8 *child)
{
    ...
    indyrescmdResponseRecieveFile(0x14,0x14,(u32 *)response1,(u32 *)response2,childsize,(u32 *)child);
    indyrescmdResponseEnd(0,0);
...
s32 indycmdAckSendDump(u8 *response)
{
    indyrescmdResponseSize(0x18,0x18);
    indyrescmdResponseSendDump(0x14,0x14,(u32 *)response);
    indyrescmdResponseEnd(0,0);
...
s32 indycmdReceiveRamRom(u32 *data1, u32 *data2, u32 *data3)
{
    indyrescmdResponseSize(0x20,0x20);
    indyrescmdResponseRecieveRamRom(0x14,0x14,data1,data2,data3);
    indyrescmdResponseEnd(0,0);
...
{
    indyrescmdResponseSize(0x18,0x18);
    indyrescmdResponseHostExportFile(0x14,0x14,(u32 *)response);
    indyrescmdResponseEnd(0,0);
...
{
    indyrescmdResponseSize(0x18,0x18);
    indyrescmdResponseHostCmdPacket(0x14,0x14,(u32 *)response);
    indyrescmdResponseEnd(0,0);
