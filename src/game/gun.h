...
Gfx *sub_GAME_7F06359C(Gfx *gdl, Mtxf *mtx, s32 green, s32 arg3, f32 *vertices, u8 *flag);
Gfx *sub_GAME_7F064364(Gfx *gdl, Mtxf *mtx, s32 arg2, f32 *vertices, u8 *flag);
Gfx *set_enviro_fog_for_items_in_solo_watch_menu(Gfx *gdl, s32 weaponnum, Mtxf *mtx, s32 alpha, s32 fogcolor);
...
f32 sub_GAME_7F0649AC(s32 weapon_id);
...
Gfx *generate_ammo_total_microcode(Gfx *arg0);
...
void gunSetOffsetRelated(f32 angle);
...
void gunSetAimType(s32 aim_type);
...
struct ModelFileHeader *get_ptr_itemheader_in_hand(GUNHAND hand);
#ifdef NATIVE_PORT
void portEnsureFirstPersonHandItemLoaded(GUNHAND hand, ITEM_IDS item);
#endif
...
typedef struct PortViewmodelTrace {
    ...
    f32 switch6[3];
    f32 switch7[3];
    f32 switch2_basis[3][3];
    f32 switch3_basis[3][3];
    f32 switch4_basis[3][3];
    f32 switch6_basis[3][3];
    f32 switch7_basis[3][3];
    f32 recoil_angle;
    f32 bolt_recoil;
    f32 depth;
    s32 raw_hand_item;
...
void portUpdateViewmodelTrace(s32 hand, ITEM_IDS item, struct hand *handdata,
                              Model *model, ModelFileHeader *itemheader,
                              const Mtxf *root_mtx);
void portGetViewmodelTrace(s32 hand, PortViewmodelTrace *out);
