...
- The release builder downloads the checksum-pinned upstream 1964GEPD binary bundle. The selected play stack uses the DesktopGoldenEye GPL core, GLideN64, AziAudio, and Mouse Injector. The same upstream archive also contains optional legacy plugins, including Jabo, and CC BY-NC-ND texture caches. Those files are not committed to this source repository.
