...
/* On NATIVE_PORT, these are declared later after the struct types are fully defined.
   The circular include (chrobjdata.h -> bondtypes.h -> chrobjdata.h) means the structs
   aren't complete here. The actual declarations are in bondgame.h post-include. */
#ifndef NATIVE_PORT
