...
#ifdef NATIVE_PORT
extern uintptr_t D_80036418;
extern uintptr_t D_8003641C;
#else
...
#ifdef NATIVE_PORT
extern void (*g_aimBoneCallback)(s32, Mtxf *);
#endif
...
// Render slot allocator: walks model node tree, consumes slots from D_80036060
void *sub_GAME_7F06B120(void *arg0, Model *model);
// called with struct ChrRecord->field_20
void sub_GAME_7F06B248(void *arg0);
// Render slot depth sort setup (computes z-depth for each slot)
void sub_GAME_7F06B29C(void *arg0);
// Render slot insertion sort by z-depth, returns sorted chain head
void *sub_GAME_7F06BB28(void *arg0);
void drawjointlist(ModelRenderData *arg0, void* arg1);
#ifdef NATIVE_PORT
void drawjointlistRegisterLevelVisibilityScaledRenderPos(void *arg0);
#endif
...
u32 sub_GAME_7F06D2E4(s32, s32, void*, void* anim, s32, s16*);
...
s32 modelGetRenderPosCount(struct Model *model);
s32 modelGetRenderPosCountForObject(struct ModelFileHeader *obj);
s32 modelGetRenderPosBytes(struct Model *model);
s32 modelGetRenderPosBytesForObject(struct ModelFileHeader *obj);
RenderPosView *modelAllocRenderPos(struct Model *model);
RenderPosView *modelAllocRenderPosForObject(struct ModelFileHeader *obj);
void modelResetHeaderRuntimeState(struct ModelFileHeader *obj);
#ifdef NATIVE_PORT
bool modelObjectContainsDataRange(const struct ModelFileHeader *obj, const void *ptr, u32 size);
#endif
void *modelGetSwitchDataSafe(struct ModelFileHeader *obj, s32 index, u32 size);
struct ModelNode *modelGetSwitchNodeBounded(struct ModelFileHeader *obj, s32 index);
struct ModelNode *modelGetSwitchNodeSafe(struct ModelFileHeader *obj, s32 index);
