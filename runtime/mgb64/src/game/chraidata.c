...
#ifdef NATIVE_PORT
/* AI bytecode data uses SGI-specific preprocessor metaprogramming (IF_ELSE, IS_EMPTY, etc.)
   that cannot compile on non-SGI compilers. Bytecode extracted from compiled N64 object
   (build/u/src/game/chraidata.o .data section) to provide identical runtime behavior. */
#include <bondtypes.h>
#include <bondaicommands.h>

static u8 m_AimAtBond[] = {
    0x14, 0x00, 0x21, 0x00, 0x00, 0x01, 0x02, 0x01, 0x03, 0x01, 0x01, 0x04
};
static u8 m_DeadAI[] = {
    0x02, 0x11, 0x03, 0x01, 0x11, 0x04
};
static u8 m_StandardGuard[] = {
    0x02, 0x01, 0x03, 0x30, 0xfd, 0x11, 0x2f, 0x06, 0x01, 0x01, 0x02, 0x06, 0x32, 0x07, 0x3e, 0x0d,
    0x3f, 0x0e, 0x46, 0x10, 0x3a, 0x0d, 0x3b, 0x0d, 0x0b, 0x03, 0x33, 0x35, 0x01, 0x03, 0x06, 0x00,
    0x02, 0x05, 0xfd, 0x00, 0x03, 0x02, 0x03, 0x01, 0x01, 0x02, 0x10, 0x33, 0x35, 0x7f, 0x07, 0x06,
    0x00, 0x02, 0x05, 0xfd, 0x00, 0x0a, 0x02, 0x07, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x06, 0x02,
    0x0d, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x08, 0x02, 0x0e, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00,
    0x0b, 0x02, 0x11, 0x05, 0xfd, 0x00, 0x01, 0x04
};
static u8 m_IdleAnimations[] = {
    0x33, 0x35, 0x32, 0x03, 0x0a, 0x00, 0x9a, 0x00, 0x00, 0x00, 0xc1, 0x18, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x35, 0x64, 0x03, 0x0a, 0x00, 0x9b, 0x00, 0x00, 0x01, 0x26, 0x18, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x35, 0x96, 0x03, 0x0a, 0x00, 0x9c, 0x00, 0x00, 0x00, 0xb7, 0x18, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x35, 0xc8, 0x03, 0x0a, 0x00, 0x9d, 0x00, 0x00, 0x00, 0x7b, 0x18, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x35, 0xfa, 0x03, 0x0a, 0x00, 0x9e, 0x00, 0x00, 0x00, 0x38, 0x18, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x0a, 0x00, 0x9f, 0x00, 0x00, 0x00, 0x89, 0x18, 0x10, 0x00, 0x02, 0x02, 0x02, 0x07, 0x04
};
static u8 m_BashKeyboard[] = {
    0x33, 0x35, 0x3c, 0x03, 0x0a, 0x00, 0xac, 0x00, 0x00, 0x00, 0x45, 0x00, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x35, 0x78, 0x03, 0x0a, 0x00, 0xad, 0x00, 0x00, 0x00, 0x4a, 0x00, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x35, 0xb4, 0x03, 0x0a, 0x00, 0xae, 0x00, 0x00, 0x00, 0x4f, 0x00, 0x10, 0x00, 0x02, 0x02,
    0x03, 0x0a, 0x00, 0xaf, 0x00, 0x00, 0x00, 0x59, 0x00, 0x10, 0x00, 0x02, 0x02, 0x02, 0x07, 0x04
};
static u8 m_SimpleGuardDeaf[] = {
    0x02, 0x01, 0x03, 0x2f, 0x06, 0x01, 0x01, 0x02, 0x06, 0x32, 0x07, 0x3e, 0x0d, 0x46, 0x10, 0x3a,
    0x0d, 0x3b, 0x0d, 0x01, 0x01, 0x02, 0x10, 0x33, 0x35, 0x7f, 0x07, 0x06, 0x00, 0x02, 0x05, 0xfd,
    0x00, 0x0a, 0x02, 0x07, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x06, 0x02, 0x0d, 0x06, 0x00, 0x02,
    0x05, 0xfd, 0x00, 0x08, 0x04
};
static u8 m_AttackBond[] = {
    0x96, 0x01, 0x03, 0x33, 0x35, 0x20, 0x03, 0x0c, 0x94, 0x01, 0x07, 0x02, 0x03, 0x94, 0x01, 0x1a,
    0x02, 0x02, 0x03, 0x33, 0x35, 0x0a, 0x03, 0x13, 0x02, 0x02, 0x03, 0x33, 0x35, 0x0a, 0x03, 0x0f,
    0x02, 0x02, 0x03, 0x33, 0x35, 0x19, 0x03, 0x0e, 0x02, 0x02, 0x03, 0x33, 0x35, 0x32, 0x03, 0x10,
    0x02, 0x02, 0x03, 0x33, 0x35, 0x40, 0x03, 0x11, 0x02, 0x02, 0x03, 0x35, 0x7f, 0x03, 0x12, 0x02,
    0x02, 0x03, 0x33, 0x35, 0x7f, 0x0b, 0x14, 0x00, 0x01, 0x00, 0x00, 0x02, 0x02, 0x0b, 0x15, 0x00,
    0x01, 0x00, 0x00, 0x02, 0x02, 0x02, 0x07, 0x04
};
static u8 m_SimpleGuard[] = {
    0x02, 0x01, 0x03, 0x32, 0x07, 0x3e, 0x0d, 0x3f, 0x0d, 0x46, 0x0d, 0x3a, 0x0d, 0x3b, 0x0d, 0x01,
    0x01, 0x02, 0x07, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x06, 0x02, 0x0d, 0x06, 0x00, 0x02, 0x05,
    0xfd, 0x00, 0x08, 0x02, 0x0e, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x0b, 0x04
};
static u8 m_RunToBond[] = {
    0x94, 0x01, 0x28, 0x01, 0x07, 0x02, 0x01, 0x03, 0x2f, 0x06, 0x32, 0x07, 0x01, 0x01, 0x02, 0x07,
    0x05, 0xfd, 0x00, 0x06, 0x02, 0x06, 0x07, 0x04
};
static u8 m_SimpleGuardAlarmRaiser[] = {
    0x02, 0x01, 0x03, 0x2f, 0x06, 0x01, 0x01, 0x02, 0x06, 0x32, 0x0f, 0x7b, 0x00, 0x10, 0x3f, 0x10,
    0x3a, 0x10, 0x3b, 0x10, 0x01, 0x01, 0x02, 0x10, 0x79, 0x00, 0x0f, 0x0d, 0x02, 0x04, 0x03, 0x2f,
    0x0f, 0x01, 0x04, 0x02, 0x0f, 0x1c, 0x23, 0x28, 0x02, 0x03, 0x03, 0x2f, 0x02, 0x01, 0x03, 0x02,
    0x02, 0x4e, 0xfd, 0x00, 0x0a, 0x23, 0x28, 0x02, 0x24, 0x23, 0x28, 0x05, 0x00, 0x02, 0x02, 0x05,
    0x03, 0x2f, 0x02, 0x01, 0x05, 0x02, 0x02, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x08, 0x04
};
static u8 m_StartleAndRunToBond[] = {
    0x0d, 0x02, 0x01, 0x03, 0x2f, 0x02, 0x01, 0x01, 0x02, 0x02, 0x05, 0xfd, 0x00, 0x08, 0x04
};
static u8 m_TryCloneSendOrRunToBond[] = {
    0x94, 0x01, 0x41, 0x0e, 0x05, 0xfd, 0x00, 0x08, 0x02, 0x0e, 0x31, 0xf9, 0x0e, 0x05, 0xfd, 0x00,
    0x02, 0x02, 0x0e, 0xc1, 0xfd, 0x00, 0x0c, 0x03, 0x05, 0xfd, 0x00, 0x08, 0x02, 0x03, 0x05, 0xfd,
    0x00, 0x02, 0x04
};
static u8 m_StandardClone[] = {
    0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x08, 0x04
};
static u8 m_RunToBondPersistent[] = {
    
};
static u8 m_WaitOneSecond[] = {
    0xae, 0x02, 0x1b, 0x03, 0xb4, 0x00, 0x00, 0x3c, 0x03, 0x01, 0x1b, 0x02, 0x03, 0x07, 0x04
};
static u8 m_EndLevel[] = {
    0xd2, 0x05, 0xfd, 0x00, 0x01, 0x04
};
static u8 m_DrawPistolAndAttackBond[] = {
    0x91, 0x28, 0x93, 0x32, 0x02, 0x03, 0x17, 0x00, 0x01, 0x00, 0x00, 0x03, 0x02, 0x03, 0xae, 0x02,
    0x1b, 0x03, 0xb4, 0x00, 0x00, 0x14, 0x03, 0x01, 0x1b, 0x02, 0x03, 0x0a, 0x00, 0x42, 0x00, 0x00,
    0x00, 0x14, 0x04, 0x10, 0x02, 0x1c, 0x03, 0x2f, 0x03, 0x01, 0x1c, 0x02, 0x03, 0xbf, 0x00, 0xcd,
    0x06, 0x00, 0x00, 0x00, 0x00, 0x03, 0x02, 0x03, 0x14, 0x00, 0x21, 0x00, 0x00, 0x03, 0x02, 0x03,
    0x16, 0x00, 0x01, 0x00, 0x00, 0x03, 0x02, 0x03, 0x02, 0x1e, 0x03, 0x2f, 0x03, 0x01, 0x1e, 0x02,
    0x03, 0x06, 0x00, 0x02, 0x05, 0xfd, 0x00, 0x08, 0x04
};
static u8 m_RemoveSelf[] = {
    0x23, 0xfd, 0x05, 0xfd, 0x00, 0x01, 0x04
};
