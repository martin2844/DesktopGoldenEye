...
struct ShotData {
    ...
    ITEM_IDS weapon;
    coord3d world_dir;
    coord3d attacker_pos;
    f32 unk34;
    ShotHitRecord hits[10];
};

s32 chrobjTrySampleModelCollisionMaterial(Model *model,
                                          ModelNode *nodearg,
                                          struct HitThing *hitthing,
                                          s32 *dstmtxindex,
                                          ModelNode **dstnode);
s32 chrobjTrySampleModelCollisionMaterialAtIndex(Model *model,
                                                 ModelNode *nodearg,
                                                 s32 sample_index,
                                                 struct HitThing *hitthing,
                                                 s32 *dstmtxindex,
...
PropRecord*          doorInit(DoorRecord* door, coord3d* pos, Mtxf* mtx, StandTile* stan, coord3d* coord, coord3d* centre, f32 fitScale);
