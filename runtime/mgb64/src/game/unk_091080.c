...
void initializeDebugCameraPosition(void)
{
    ...
    (void)bondviewGetCurrentPlayersPosition();  //normally would return a coord3d pos but not here
...
{
    (void)sqrtf((debugCameraPosition.x - debugCameraPreviousPosition.x) * (debugCameraPosition.x - debugCameraPreviousPosition.x) +
