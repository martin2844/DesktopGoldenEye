...
/*
 * Clean-room Audio Binary Interface declarations. The constants, packet
 * layouts, and command-builder macros describe the N64 audio microcode command
 * ABI used by matching-target and native audio translation code.
 */
