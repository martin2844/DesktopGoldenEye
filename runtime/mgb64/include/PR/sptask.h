#ifdef NATIVE_PORT
/* On PC, platform_os.h provides task types */
#else
...
/*
 * RSP task descriptor used by graphics, audio, and video microcode jobs.
 * Pointers identify boot code, task code/data, optional stacks/output buffers,
 * and optional yield buffers. Buffers written by the RCP must be cache-line
 * aligned by callers on real N64 hardware.
 */
typedef struct
{
    /*0x00*/ u32 type;
