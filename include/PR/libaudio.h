/*
 * Clean-room audio-library compatibility declarations and constants shared by
 * the native audio port and matching-target sources.
 */
...
typedef intptr_t (*ALDMAproc)(s32 addr, s32 len, void *state);
#else
