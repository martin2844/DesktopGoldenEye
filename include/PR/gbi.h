/*
 * Clean-room Graphics Binary Interface compatibility declarations, constants,
 * and display-list helper macros shared by native and matching-target sources.
 */
#ifndef _GBI_H_
#define _GBI_H_
...
#define	GPACK_RGBA5551(r, g, b, a)	(((((u32)(r))<<8) & 0xf800) | 		\
					 ((((u32)(g))<<3) & 0x7c0) |		\
					 ((((u32)(b))>>2) & 0x3e) | ((a) & 0x1))
